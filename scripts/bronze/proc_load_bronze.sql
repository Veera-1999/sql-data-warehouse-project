...
USE [DataWarehouse]
GO
/****** Object:  StoredProcedure [bronze].[load_bronze]    Script Date: 14-02-2026 17:54:09 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		...
		TRUNCATE TABLE bronze.crm_cust_info--TRUNCATE will quickly delete all rows from a table, resetting it to an empty state
		...
		WITH( --Use these settings when importing the file.
			...
			TABLOCK --Lock the entire table for the duration of this operation
		);
